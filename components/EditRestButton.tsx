...
import { editRestaurantData } from "../app/actions";

export default function EditRestButton({
  rest,
  types,
}: {
  rest: any;
  ...
  const [typeInput, setTypeInput] = useState(rest.type ? rest.type.name : "");
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await editRestaurantData(formData);
    setIsOpen(false);
  };
